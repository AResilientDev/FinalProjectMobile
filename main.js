...
function create() {
  ...
  //background images
  sky = game.add.tileSprite(0, 0, window.innerWidth *  window.devicePixelRatio, window.innerHeight *  window.devicePixelRatio, 'sky');
  mountains = game.add.tileSprite(0, 0, window.innerWidth *  window.devicePixelRatio, window.innerHeight *  window.devicePixelRatio, 'mountains');
  city = game.add.tileSprite(0, 0, window.innerWidth *  window.devicePixelRatio, window.innerHeight *  window.devicePixelRatio, 'city');
  ...
  messageText = game.add.text(700,100, '', {fontsize: '1.2em', fill: '#fffea7'} );
